...
switch (gameMode) do {
	...
	case 5: {
				player createDiaryRecord ["Diary",[format [localize "STR_antistasi_journal_entry_header_gamemode"],format [localize "STR_antistasi_journal_entry_text_gamemode_5",nameInvaders,nameTeamPlayer]]]
			};
