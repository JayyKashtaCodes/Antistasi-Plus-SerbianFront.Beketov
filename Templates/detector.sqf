...
//Actual Detection
//VTNNova Detection
if (isClass (configFile >> "CfgPatches" >> "anus_veteranus")) then {
    private _text = "VTNNova detected!";
    systemChat _text;
    [2, _text, _fileName] call A3A_fnc_log;
	A3A_hasVTNNova = true;
};

//PiR Detection
if (isClass (configFile >> "CfgPatches" >> "PiR_basicanim")) then {
    private _text = "PiR detected!";
    systemChat _text;
    [2, _text, _fileName] call A3A_fnc_log;
	A3A_hasPiR = true;
};
