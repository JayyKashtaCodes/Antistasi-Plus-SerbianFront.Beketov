...
if (!isNil "_customLoadout") exitWith {
	...
	[_unit, selectRandom["Male01RUS", "Male02RUS", "Male03RUS"]] remoteExec ["setSpeaker", 0, true];
...
_unit setUnitLoadout [ [], [], [],    [uniform _unit, []], [], [],    "", "", [],
	["ItemMap","","tf_anprc148jem","ItemCompass","ItemWatch",""] ];		// no GPS, radio, NVG
...
sleep 1;
//{[_x,""] call BIS_fnc_setUnitInsignia;} forEach (allUnits select {alive _x && side _x == teamPlayer});
