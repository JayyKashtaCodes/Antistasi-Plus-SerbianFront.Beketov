...
private _taskString = format ["We have spotted a %3 SpecOp team patrolling around a %1. Ambush them and we will have one less problem. Do this before %2. Be careful, they are tough boys. <br/> <br/> Мы заметили спецназ %3, патрулирующий вокруг <marker name='%1'>%1</marker>. Устройте им засаду, и у нас будет на одну проблему меньше. Сделайте это до %2. Будьте осторожны, они очень круты.",_nameDest,_displayTime];
