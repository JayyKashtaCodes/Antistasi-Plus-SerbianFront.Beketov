...
private _taskText = format ["Artillery is firing at our positions from %1. We must destroy it or kill it's crew. Do this before %2, or they will destroy something valuable. <br/> <br/> Артиллерия ведет огонь по нашим позициям с <marker name='%1'>%1</marker>. Мы должны уничтожить её или убить стрелков. Сделайте это до %2, или они уничтожат что-то ценное для нас.", _nameDest, _displayTime];
