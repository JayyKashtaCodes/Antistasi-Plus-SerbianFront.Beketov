...
[[teamPlayer,civilian],_taskId,[format ["We know Gendarmes are guarding a large amount of money in the bank of %1. Take this truck and go there before %2, hold the truck close to tha bank's main entrance for 2 minutes and the money will be transferred to the truck. Bring it back to HQ and the money will be ours. <br/> <br/> Мы знаем, что инкосаторы охраняют большую сумму денег в банке <marker name='%1'>%1</marker>. Доберитесь до этого грузовика до %2, удерживайте грузовик рядом с главным входом в банк в течении 2 минут, и деньги будут загружены в грузовик. Привезите его обратно в штаб-квартиру, и деньги будут нашими.",_nameDest,_displayTime],"Bank Robbery",_mrkFinal],_positionX,false,0,true,"Interact",true] call BIS_fnc_taskCreate;
