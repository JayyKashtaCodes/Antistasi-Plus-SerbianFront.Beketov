...
private _rebelTaskText = format [
    "High-ranked officer will move from %1 to %2 at %3. Intercept his vehicle and eliminate him. We must do it before %4. <br/> <br/> Высокопоставленный офицер передвигается из <marker name='%1'>%1</marker> в <marker name='%2'>%2</marker> до %3. Перехватите его автомобиль и уничтожьте его. Вы должны сделать это до %4.", 
    _originName, 
    _destinationName,
