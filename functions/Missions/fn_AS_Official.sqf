...
private _taskString = format ["A %4 officer is inspecting %1. Go there and kill him before %2:%3. <br/> <br/> Офицер по именем %4 проводит инспекцию в <marker name='%1'>%1</marker>. Отправляйтесь туда и убейте его до %2:%3.",_nameDest,numberToDate [2022,_dateLimitNum] select 3,numberToDate [2022,_dateLimitNum] select 4,_naming];
