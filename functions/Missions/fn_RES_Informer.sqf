...
[2, format ["Rescue Rebel Informer task initialization started, marker: %1. <br/> <br/> Миссия спасение информатора повстанцев начата %1", _markerX], _fileName] call A3A_fnc_log;
...
private _text = format [
    "%1 forces sweeps %2 in search of our civilian informer with some very valuable data. He's hiding in one of the city's buildings. We have to get him out of there or he will be killed and our intel source will be exposed. He will shoot flare in the sky when we will be close to him. Bring him to our %3 HQ. Do this before %4. <br/> <br/> %1 проводят зачистку населенного пункта <marker name='%2'>%2</marker> в поисках нашего информатора с очень ценными данными. Он прячется в одном из городских зданий. Мы должны вытащить его оттуда, или его убьют, и наш источник информации будет потерян. Он выпустит сигнальную ракету в небо, когда мы будем рядом с ним. Приведите его в наш штаб %3. Выполните это до %4.", _sideTitle, _destinationName, nameTeamPlayer, _displayTime];
