...
[[teamPlayer,civilian],_taskId,[format ["We've spotted an Ammotruck in an %1. Go there and destroy or steal it before %2. <br/> <br/> Мы заметили грузовик с боеприпасами в <marker name='%1'>%1</marker>. Отпарвляйтесь туда и уничтожьте или украдите его до %2.",_nameDest,_displayTime],"Steal or Destroy Ammotruck",_markerX],_pos,false,0,true,"rearm",true] call BIS_fnc_taskCreate;
