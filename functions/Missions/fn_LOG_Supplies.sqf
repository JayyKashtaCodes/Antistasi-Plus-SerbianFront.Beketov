...
_taskDescription = format ["<marker name='%1'>%1</marker> population is in need  of supplies. We may improve our relationship with that city if we are the ones who provide them. I have placed a crate with supplies near our HQ. Deliver the crate to <marker name='%1'>%1</marker> city center, hold it there for %3 minutes and it's done. Do this before %2. <br/> <br/> Жители населённого пункта <marker name='%1'>%1</marker> нуждаются в припасах. Мы можем улучшить наши отношения с этим населённым пунктом, если мы их обеспечим всем необходимым. Я поставил ящик с припасами возле нашего штаба. Доставьте ящик в центр населённого пункта <marker name='%1'>%1</marker>, раздавайте гумманитарную помощь в течении %3 минут(ы). Выполните это до %2.", _nameDest, _displayTime, _holdTime];
