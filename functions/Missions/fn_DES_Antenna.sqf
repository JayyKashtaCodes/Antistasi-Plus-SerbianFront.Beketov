...
[[teamPlayer,civilian],_taskId,[format ["We need to destroy or take a Radio Tower in %1. This will interrupt %3 Propaganda Nework. Do it before %2. <br/> <br/> Нам нужно уничтожить или захватить Радиовышку в <marker name='%1'>%1</marker>. Это прекратит пропоганду %3. Выполните это до% 2.",_nameDest,_displayTime,_sideName],"Destroy Radio Tower",_mrkFinal],_positionX,false,0,true,"Destroy",true] call BIS_fnc_taskCreate;
