...
[
	...
	_taskId,
	[
		format ["%3 is rebuilding a radio tower in <marker name='%1'>%1</marker>. If we want to keep up the enemy comms breakdown, the work must be stopped. Destroy the repair truck parked nearby or capture the zone. Work will be finished on %2. <br/><br/> %3 восстанавливают радиовышку в населённом пункте <marker name='%1'>%1</marker>. Если мы хотим оставить противника без связи, работы по восстанавлению должны быть остановлены. Уничтожьте припаркованный неподалёку ремонтный грузовик или захватите зону. Работа по восстанавлению радиовышки завершится в %2.",_nameDest,_displayTime,nameOccupants],
