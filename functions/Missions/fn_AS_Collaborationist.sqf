...
//Tasks
////////////
private _text = format ["A police officer terrorizes %1 population. Kill him and people will breathe freely. Do this before %2. <br/> <br/> Оборотень в погонах терроризирует население <marker name='%1'>%1</marker>. Убейте его, и люди вздохнут свободно. Сделайте это до %2.", _destinationName,_displayTime];
