...
private _rebelTaskText = format [
    "%1 helicopter with some valueable cargo has been shot down in %2. Bring helicopter's cargo to the HQ before enemy's rescue team. We must get it before %3. <br/> <br/> %1 вертолет с ценным грузом был сбит в <marker name='%2'>%2</marker>. Доставьте груз из вертолета в штаб-квартиру раньше вражеской спасательной команды. Мы должны забрать его до %3.", 
    _sideName, 
    _destinationName,
    _displayTime
];
