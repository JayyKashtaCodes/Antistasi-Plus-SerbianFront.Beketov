...
[[teamPlayer,civilian],_taskId,[format ["A group of POWs is awaiting for execution in %1. We must rescue them before %2. Bring them to HQ <br/> <br/> Группа военнопленных ожидает казни в <marker name='%1'>%1</marker>. Мы должны успеть спасти их до %2. Доставьте их в штаб-квартиру",_nameDest,_displayTime],"POW Rescue",_markerX],_positionX,false,0,true,"run",true] call BIS_fnc_taskCreate;
