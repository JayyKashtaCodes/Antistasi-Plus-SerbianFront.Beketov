...
[
    [teamPlayer,civilian],
    _taskId,
    [format ["Whether %1 wanted it or not, an arms dealer has arrived on %2. So let's get to buy some weapons and gear from him, one by one. %3. From what i can gather he trades his goods from a hideout in the forest outside of major cities. He's well hidden, but with the right team, we can punch through those trees, find this man out and establish contact with black market. <br/> <br/> Хотели этого %1 или нет, но на %2 прибыл торговец оружием. Так что давайте купим у него оружие и снаряжение, одно за другим. %3. Насколько я могу судить, он торгует своими товарами из укрытия в лесу за пределами крупных городов. Он хорошо спрятан, но с правильной командой мы сможем пробиться сквозь эти деревья, найти этого человека и установить контакт с черным рынком.",nameOccupants,_worldName,name traderX, nameOccupants],
