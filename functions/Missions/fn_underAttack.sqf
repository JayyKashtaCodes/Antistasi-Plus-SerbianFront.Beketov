...
[_sideX,_markerX,[format ["%2 is attacking us in %1. Help the defense if you can <br/> <br/> Армия %2 атакует нас в <marker name='%1'>%1</marker>. Помогите защититься",_nameDest,_nameENY],format ["%1 Contact Report",_nameENY],_markerX],getMarkerPos _markerX,false,0,true,"Defend",true] call BIS_fnc_taskCreate;
