...
[[teamPlayer,civilian],_taskId,[format ["Enemy knows our HQ coordinates. They have sent a SpecOp Squad in order to kill %1. Intercept them and kill them. Or you may move our HQ 1Km away so they will loose track <br/> <br/> Враг знает координаты расположения нашего штаба. Они отправили отряд спецназа, чтобы убить %1. Перехватите их и убейте. Или вы можете переместить нашу штаб-квартиру на 1 км, чтобы они потеряли след.",name petros],format ["Defend %1",name petros],["Защищайте %1",name petros],respawnTeamPlayer],_positionX,true,10,true,"Defend",true] call BIS_fnc_taskCreate;
[[_sideX],_taskId+"B",[format ["We know %2 HQ coordinates. We have sent a SpecOp Squad in order to kill his leader %1. Help the SpecOp team <br/> <br/> Нам известны координаты штаб-квартиры %2. Мы отправили спецназ, чтобы убить его лидера %1. Помогите спецназу",name petros, nameTeamPlayer],format ["Kill %1",name petros], ["Убейте %1",name petros],respawnTeamPlayer],_positionX,true,10,true,"Attack",true] call BIS_fnc_taskCreate;
