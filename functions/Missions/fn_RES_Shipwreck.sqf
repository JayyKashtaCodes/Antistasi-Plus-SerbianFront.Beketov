...
private _taskText = format ["A smuggler's ship has been crashed %1. We must rescue survivors before %2. Bring them to HQ. <br/> <br/> Корабль контрабандиста потерпел крушение в <marker name='%1'>%1</marker>. Мы должны спасти выживших до %2. Доставьте их в штаб-квартиру.", _nameDest, _displayTime];
