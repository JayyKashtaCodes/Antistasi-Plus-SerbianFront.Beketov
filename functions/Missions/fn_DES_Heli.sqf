...
private _text = format ["We have downed a helicopter. There is a good chance to destroy it before it is recovered. Do it before a recovery team from %1 reaches the crash site. MOVE QUICKLY <br/> <br/> Мы подбили вертолет. Есть  шанс уничтожить его до того, как он будет отремонтирован. Сделайте это до того, как команда инженеров из %1 доберется до места аварии. ДВИГАЙТЕСЬ БЫСТРО",_location];
