...
[[teamPlayer,civilian],_taskId,[format ["We know an enemy armor (%3) is stationed in %1. It is a good chance to destroy or steal it before it causes more damage. Do it before %2. <br/> <br/> Мы знаем, что вражеское вооружение (%3) размещено в <marker name='%1'>%1</marker>. Это хороший шанс уничтожить или украсть его, прежде чем он нанесет больший ущерб. Сделайте это до% 2.",_nameDest,_displayTime,getText (configFile >> "CfgVehicles" >> (_typeVehX) >> "displayName")],"Steal or Destroy Armor",_markerX],_positionX,false,0,true,"Destroy",true] call BIS_fnc_taskCreate;
