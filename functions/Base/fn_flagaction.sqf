...
switch _typeX do
{
	...
	case "Flag NR":
    {
        _flag addAction ["Flag NR", {flagX setFlagTexture "\RUS_markers_flags\flag_rnr_co.paa";
			},nil,0,false,true,"","(_this == theBoss)",4];
    };
	case "Flag DNR":
    {
        _flag addAction ["Flag DNR", {flagX setFlagTexture "\RUS_markers_flags\flag_dnr_co.paa";
			},nil,0,false,true,"","(_this == theBoss)",4];
    };
	case "Flag LNR":
    {
        _flag addAction ["Flag LNR", {flagX setFlagTexture "\RUS_markers_flags\flag_lnr_co.paa";
			},nil,0,false,true,"","(_this == theBoss)",4];
    };
	case "Flag RUS":
    {
        _flag addAction ["Flag RUS", {flagX setFlagTexture "rhsafrf\addons\rhs_main\data\flag_rus_co.paa";
			},nil,0,false,true,"","(_this == theBoss)",4];
    };
	case "Flag CCCP":
    {
        _flag addAction ["Flag CCCP", {flagX setFlagTexture "\RUS_markers_flags\flag_ussr_co.paa";
			},nil,0,false,true,"","(_this == theBoss)",4];
    };
    case "vehicle":
    {
